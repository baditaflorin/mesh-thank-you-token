...
**Live → https://baditaflorin.github.io/mesh-thank-you-token/**

**Source → https://github.com/baditaflorin/mesh-thank-you-token**
...
git clone https://github.com/baditaflorin/mesh-thank-you-token
...
- `mesh-thank-you-token:signalingUrl`
- `mesh-thank-you-token:turnTokenUrl`
- `mesh-thank-you-token:iceServers`
- `mesh-thank-you-token:room`
